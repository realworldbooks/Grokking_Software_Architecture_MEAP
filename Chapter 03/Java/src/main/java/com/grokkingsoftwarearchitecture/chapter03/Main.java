package com.grokkingsoftwarearchitecture.chapter03;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("\n\n=== Grokking Software Architecture Chapter 02: Java Examples ===\n");
                ...
                if (selectedExample != null) {
                    ...
                    try {
                        ...
                        // Find the public static run() method
                        ...
                        System.out.println("[ERROR] Could not find a public static run() method on " + selectedExample.getType());
                    } catch (Exception e) {
